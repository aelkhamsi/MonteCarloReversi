...
class MonteCarloTree:
    ...
    def selection(self, node):
        """ Return the node's child with the maximum ubc score """
    ...
    def expansion(self, parent):
        """ Expand the search tree by adding new nodes """
    ...
    def evaluation(self):
        """ Evaluate the current board by counting the number of white and
            black pieces

            Returns 1 if it's a winning state, 0 otherwise
        """
